...
public class FavoriteProductAdaptor extends RecyclerView.Adapter<FavoriteProductAdaptor.ViewHolder> {

    private Context context;
    private List<Product> favoriteList;
    private OnFavoriteRemoveClickListener listener;

    public FavoriteProductAdaptor(Context context, List<Product> favoriteList, OnFavoriteRemoveClickListener listener) {
